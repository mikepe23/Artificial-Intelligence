...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        ghostPositions = [d.argMax() for d in livingGhostPositionDistributions]
        
        # find closest ghost
        closestGhost, closestDist = None, float('inf')
        ...
        # compute action that minimizes distance to ghost
        minAction, minDistance = None, float('inf')
        for action in legal:
